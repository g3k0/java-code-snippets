    ...
    private void consume() throws InterruptedException {
        ...
        while (bufferCondiviso.isEmpty()) {
            synchronized (bufferCondiviso) {
                System.out.println("Il buffer � vuoto, il thread Consumer resta in attesa... la dimensione del buffer adesso �: " + bufferCondiviso.size());
        ...
        synchronized (bufferCondiviso) {
        	System.out.println("Il thread Consumer sta leggendo il buffer ed eliminando il seguente elemento: " + bufferCondiviso.remove(0) + " la dimensione del buffer adesso �: " + bufferCondiviso.size());
